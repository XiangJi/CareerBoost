...
/*
 * Use tree map to store <start, end>
 * NlogN
 * floor = largest element smaller than q.start
 * ceiling = smallest element bigger than q.start
 */
class MyCalendarII {
...
// since no overlap: Ordered TreeMap<Start, end>
/**
